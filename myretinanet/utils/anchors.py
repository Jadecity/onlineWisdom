...
from myretinanet.utils import argmax_matcher
from myretinanet.utils import box_list
from myretinanet.utils import faster_rcnn_box_coder
from myretinanet.utils import region_similarity_calculator
from myretinanet.utils import target_assigner
...
class AnchorLabeler(object):
  ...
  def _unpack_labels(self, labels):
    ...
    feat_size_dict = {3:40, 4:20, 5:20, 6:10, 7:5}
    ...
    for level in range(anchors.min_level, anchors.max_level + 1):
      ...
      feat_size = feat_size_dict[level]
